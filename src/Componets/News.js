      ...
      <div className="container my-3">
        ...
        <div className="row">
          <div className="col-md-4">
            <NewsItem title="title" discription="mydesc" imageUrl="https://www.reuters.com/resizer/w4pjI5JlvB_pshqV4hN-uthyRYY=/1200x628/smart/filters:quality(80)/cloudfront-us-east-2.images.arcpublishing.com/reuters/3W3WSPQ3C5KVRAWJI2YIQPE72Y.jpg"
            newsUrl="TODO"/>
          </div>
          <div className="col-md-4">
            <NewsItem title="title" discription="mydesc"/>
          </div>
          <div className="col-md-4">
            <NewsItem title="title" discription="mydesc"/>
          </div>
